                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="gallery-filter">
                            ...
                            <span class="filter-item" data-filter="ballet">Ballet</span>
                            <span class="filter-item" data-filter="hiphop">Hip-hop</span>
                            ...
                            <span class="filter-item" data-filter="folclore">Folclore</span>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="gallery-item ballet">
                            <div class="gallery-item-inner">
                                <img src="{{ asset('img/mapaaulas/calendar_ballet.png') }}" alt="ballet">
                            </div>
                        </div>

                        <div class="gallery-item folclore">
                            <div class="gallery-item-inner">
