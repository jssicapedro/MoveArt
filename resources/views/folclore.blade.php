...
<div class="about">
    ...
    <img src="{{ url('storage/modalidades/'.$modalidade->foto_desc) }}" alt="Criança a treinar folclore de tutu dentro de uma forma irregular sem background e com borda de cor de rosa">
</div>
<div class="advisors">
    <h2>Orientadores</h2>
    ...
    <div id="carousel" class="carousel carousel-dark slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img width="100%" src="{{ asset('img/dancas/folclore/calendar_folclore.png') }}" class="d-block" alt="...">
            </div>
        </div>
...
<div class="calendar_mobile">
    <h2>Horário</h2>
    <div class="image">
        <img src="{{asset('img/dancas/folclore/calendar_folclore.png') }}" data-toggle="modal" data-target="#exampleModal" />
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img width="100%" src="{{ asset('img/dancas/folclore/calendar_folclore.png') }}" />
                    </div>
                </div>
            </div>
        </div>
