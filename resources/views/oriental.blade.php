...
<div class="about">
    ...
    <img src="{{ url('storage/modalidades/'.$modalidade->foto_desc) }}" alt="Criança a treinar oriental de tutu dentro de uma forma irregular sem background e com borda de cor de rosa">
</div>
<div class="advisors">
    <h2>Orientadores</h2>
