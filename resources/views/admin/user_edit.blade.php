                                        ...
                                        <div class="profile-pic-div">
                                            <div class="fotoo">
                                                ...
                                                <img src="{{ asset('img/inicio/user.jpg') }}"
                                                    alt="user" id="photo">
                                            @else
                                            <img src="{{ url('storage/professores/' . $user->foto) }}" id="photo"> 
                                            @endif
                                ...
                                <div class="col-3 ">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="primeiro" id="priemrionome"
                                            class="form-control form-control-sm input_style" value="{{ $user->primeiro }}">
                                ...
                                <div class="col-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="apelido" id="apelido"
                                            class="form-control form-control-sm input_style" value="{{ $user->apelido }}">
                                ...
                                <div class="col-3 col_height">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="tel" name="telefone" id="telefone"
                                            class="form-control form-control-sm input_style" value="{{ $user->telefone }}">
                                ...
                                <div class="col-3 col_height">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="email" id="email"
                                            class="form-control form-control-sm input_style" value="{{ $user->email }}">
                                ...
                                <div class="col-3 col_height">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="cc" id="cc"
                                            class="form-control form-control-sm input_style" value="{{ $user->cc }}">
                                            @error('cc')
                                            <p class="msg_p">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-3 col_height offset-md-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="nif" id="nif"
                                            class="form-control form-control-sm input_style" value="{{ $user->nif }}">
                                            @error('nif')
                                            <p class="msg_p">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-3 col_height offset-md-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="localidade" id="localidade"
                                            class="form-control form-control-sm input_style" value="{{ $user->localidade }}">
                                            @error('localidade')
                                            <p class="msg_p">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-3 col_height">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="rua" id="rua"
                                            class="form-control form-control-sm input_style" value="{{ $user->rua }}">
                                            @error('rua')
                                            <p class="msg_p">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-3 col_height">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="cod_postal" id="cod_postal"
                                            class="form-control form-control-sm input_style" value="{{ $user->cod_postal }}">
                                            @error('cod_postal')
                                            <p class="msg_p">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-3 col_height">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select form-select-sm input_style" name="modalidade_id"
                                            ...
                                            <option value="3" >Dança Espanhola</option>
                                            <option value="4" >Dança Oriental</option>
