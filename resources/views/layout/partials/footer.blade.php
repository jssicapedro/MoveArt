<footer>
        <section id="first">
            ...
            <div class="redes_sociais">
                <ul>
                    <li><a href="#"><img src="{{asset('img/footer/icons8-facebook-256.png')}}" alt="icon facebook"></a></li>
                    <li><a href="#"><img src="{{asset('img/footer/icons8-instagram-256.png')}}" alt="icon instagram"></a></li>
                    <li><a href="#"><img src="{{asset('img/footer/icons8-myspace-256.png')}}" alt="icon linkedin"></a></li>
                </ul>
            </div>
        </section>
        <hr>
        <section id="second">
                ...
                <div class="produtos">
                    ...
                    <ul>
                        ...
                        <li><a href="">Pacote de Aulas</a></li>
        ...
        <section id="third">
            <div class="direito">
                <p>&copy; 2022 MoveArt Inc. Todos os direitos reservados.</p>
            </div>
        </section>
    </footer>