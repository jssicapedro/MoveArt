...
@section('main')
    <div class="about">
            ...
            <img src="{{ asset('img/dancas/hiphop/hiphop_app.png') }}"
                alt="Criança a treinar hiphop de tutu dentro de uma forma irregular sem background e com borda de cor de rosa">
        </div>
        <div class="advisors">
            <h2>Orientadores</h2>
            <div class="advisors_prof">
                <div>
                    <img class="grafic1" style="position: absolute;"
                        src="{{ asset('img/dancas/hiphop/hiphop_prof_.png') }}" alt="">
            ...
            <div id="carousel"
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img width="100%" src="{{ asset('img/dancas/calendar.png') }} class="d-block"
                            alt="...">
                    </div>
                    <div class="carousel-item">
                        <img width="100%" src="{{ asset('img/dancas/hiphop/calendar_hiphop.png') }}
                            class="d-block" alt="...">
                    </div>
                </div>
        ...
        <div class="calendar_mobile">
            <h2>Horário</h2>
            <div class="image">
                <img src="{{asset('img/dancas/hiphop/calendar_hiphop.png') }} data-toggle="modal" data-target="#exampleModal" />
