...
<div class="about">
    ...
    <img src="{{ url('storage/modalidades/'.$modalidade->foto_desc) }}" alt="Criança a treinar hiphop de tutu dentro de uma forma irregular sem background e com borda de cor de rosa">
</div>
<div class="advisors">
    <h2>Orientadores</h2>
    ...
    <div id="carousel" class="carousel carousel-dark slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img width="100%" src="{{ asset('img/dancas/hiphop/calendar_hiphop.png') }}" class="d-block" alt="...">
            </div>
        </div>
